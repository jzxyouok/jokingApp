...
public class WrapperListPreference extends ListPreference {
    ...
    private String getFieldValue(String filed) throws Exception {
        Field titleField = WrapperListPreference.class.getSuperclass().getSuperclass().getDeclaredField(filed);
                ...
                new AlertDialogWrapper.Builder(getContext())
                        ...
                        .setSingleChoiceItems(mEntriesStrArr, mClickedDialogEntryIndex, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                try {
                                    Field titleField = WrapperListPreference.class.getSuperclass().getDeclaredField("mClickedDialogEntryIndex");
                                    titleField.setAccessible(true);
